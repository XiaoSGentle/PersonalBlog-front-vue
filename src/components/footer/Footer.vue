<template>
    <div v-if="menusVisible" flex justify-center p3>
        <div w140 font-bold text-black>
            <div leading-8>Copyright © 2023 | Xiaos| Reacool </div>
        </div>
        <div w60>
    ...
    <div v-if="!menusVisible" flex justify-center p3>
        <div w140 font-bold text-black>
            <div leading-8>Copyright © 2023 Xiaos| Reacool | 个人主页 | Welcome to here! </div>
        </div>
        <div w60>
            <div flex justify-around>
                <IconQQ></IconQQ>
