<template>
    <div>
        ...
        <div mt10 flex justify-end>
            <el-button w30 round type="primary">上传</el-button>
        </div>
        ...
        <el-table :data="fineFoodList" style="width: 100%" center>
            ...
            <el-table-column prop="name" label="图片详情"></el-table-column> //按顺序显示
            <el-table-column prop="name" label="是否展示"></el-table-column> //按顺序显示
